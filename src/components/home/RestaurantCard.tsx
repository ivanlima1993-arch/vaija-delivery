        ...
        >
          ...
          <div className="p-3 sm:p-5">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <div className="flex-1 flex items-center justify-between p-1.5 sm:p-3 bg-muted/30 rounded-xl sm:rounded-2xl gap-1 sm:gap-2 group-hover:bg-primary/5 transition-colors">
