        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/seja-franqueado" className="hover:text-primary transition-colors font-bold text-blue-500 flex items-center gap-1">Seja um Franqueado</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/ajuda" className="hover:text-primary transition-colors font-bold text-primary">Central de Ajuda (FAQ)</Link></li>
