...
export const DISPLAY_CATEGORIES: Category[] = [
  ...
  { id: "real-estate", name: "Imóveis", icon: Home, color: "bg-emerald-100 text-emerald-600" },
  { id: "professionals", name: "Serviços", icon: Wrench, color: "bg-blue-100 text-blue-600" },
  { id: "gas", name: "Gás", icon: Flame, color: "bg-orange-100 text-orange-600" },
  ...
  { id: "fashion", name: "Moda", icon: FashionIcon, color: "bg-pink-100 text-pink-600" },
  { id: "water", name: "Água", icon: Droplets, color: "bg-cyan-100 text-cyan-600" },
  { id: "beauty", name: "Beleza", icon: Scissors, color: "bg-purple-100 text-purple-600" },
  { id: "stationery", name: "Papelaria", icon: BookOpen, color: "bg-indigo-100 text-indigo-600" },
